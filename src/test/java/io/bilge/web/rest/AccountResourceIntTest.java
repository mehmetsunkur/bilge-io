...
import io.bilge.config.Constants;
import io.bilge.BilgeApp;
import io.bilge.domain.Authority;
import io.bilge.domain.User;
import io.bilge.repository.AuthorityRepository;
import io.bilge.repository.UserRepository;
import io.bilge.security.AuthoritiesConstants;
import io.bilge.service.MailService;
import io.bilge.service.dto.UserDTO;
import io.bilge.web.rest.errors.ExceptionTranslator;
import io.bilge.web.rest.vm.KeyAndPasswordVM;
import io.bilge.web.rest.vm.ManagedUserVM;
import io.bilge.service.UserService;
