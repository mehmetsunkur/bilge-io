...
describe('Service Tests', () => {
    ...
    describe('DataTableBilge Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DataTableBilgeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-tables';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DataTableBilge', () => {

                let entity: DataTableBilge;
                service.find(123).subscribe((_entity: DataTableBilge) => {
                    entity = _entity;
                });
