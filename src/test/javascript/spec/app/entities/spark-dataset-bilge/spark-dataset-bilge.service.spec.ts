...
describe('Service Tests', () => {
    ...
    describe('SparkDatasetBilge Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SparkDatasetBilgeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/spark-datasets';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SparkDatasetBilge', () => {

                let entity: SparkDatasetBilge;
                service.find(123).subscribe((_entity: SparkDatasetBilge) => {
                    entity = _entity;
                });
