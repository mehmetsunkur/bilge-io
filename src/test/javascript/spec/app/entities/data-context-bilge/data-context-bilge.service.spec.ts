...
describe('Service Tests', () => {
    ...
    describe('DataContextBilge Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DataContextBilgeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-contexts';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DataContextBilge', () => {

                let entity: DataContextBilge;
                service.find(123).subscribe((_entity: DataContextBilge) => {
                    entity = _entity;
                });
