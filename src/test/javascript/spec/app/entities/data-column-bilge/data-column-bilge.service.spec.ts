...
describe('Service Tests', () => {
    ...
    describe('DataColumnBilge Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DataColumnBilgeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-columns';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DataColumnBilge', () => {

                let entity: DataColumnBilge;
                service.find(123).subscribe((_entity: DataColumnBilge) => {
                    entity = _entity;
                });
